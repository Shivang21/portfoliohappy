      ...
      <div className="projects">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>RC Teambuilder- Performace Module </h3>
              <p>
              Supervisors and HR give the Reward to the employee according to his/her performance. Goals can be assigned to the employees by the supervisor and points for the goal completion will be given on daily basis. HR can send the Appraisal letters to there employees. Kudos to the best employee. </p>
            </div>
            <footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>Realcoderz Notifications </h3>
              <p>
              Employee gets the notification regarding other Employees birthdays and Anniversary.Employee gets notification if the gets kudos and rewards another end, to give the blood. </p>
            </div>
            <footer>
              <ul className="tech-list">
              <li>Nodejs</li> <li>Reactjs</li><li>Javascript</li> <li>Nodejs</li><li>Html</li><li>Css</li>
              </ul>
            </footer>
          </div>
        </ScrollAnimation>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>RC Teambuilder- Video Conferencing Module </h3>
              <p> Interviewer can create a virtual meeting with the candidate, where video call, audio call screensharing ,code compiler ,live chatting and file sharing option are available,Complier result are show over their directly and also at the candidates profile, to the interviewer Any media type file can be shared in the chat Meeting can be joined through the link or even through the room id.  </p>
            </div>
            <footer> <ul className="tech-list"> <li>Nodejs</li> <li>Reactjs</li><li>Express</li> <li>Webrtc</li><li>WebScocket</li></ul> </footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              ...
              <p>created some login signup Api for the cryptocurrency project. Authentication api. </p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>Laravel</li>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>B2B Shopping site</h3>
              <p>Our B2B shopping site, built with Laravel and AJAX, provides a seamless platform for businesses to procure products efficiently. Leveraging Laravel's robustness and AJAX's real-time interactions, we ensure smooth navigation and dynamic updates. With a vast product catalog, intuitive interfaces, and responsive design, we prioritize usability and convenience. Our platform redefines B2B transactions, empowering businesses with streamlined procurement processes.</p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>Laravel</li>
